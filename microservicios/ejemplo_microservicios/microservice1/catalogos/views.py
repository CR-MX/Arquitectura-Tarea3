...
class CategoryViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        messages = Category.objects.all()
        # Se crea el serializer y se envía como response
        serializer = CategorySerializer(messages, many=True)
    ...
    def retrieve(self, request, pk=None):
        ...
        message = Category.objects.get(id=pk)
        # Se crea el serializer
        serializer = CategorySerializer(message)
    ...
    def update(self, request, pk=None): 
        ...
        message = Category.objects.get(id=pk)
        # Se crea el serializer con los datos recibidos
        serializer = CategorySerializer(instance=message, data=request.data)
        # Se verifica si el serializer es válido
        serializer.is_valid(raise_exception=True)
        # Se guarda el serializer
        serializer.save()
...
class ProductViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        # Se crea el serializer y se envía como response
        serializer = ProductSerializer(messages, many=True)
        return Response(serializer.data)
    ...
    def retrieve(self, request, pk=None):
        # Se obtiene el mensaje con ayuda del pk recibido
        message = Product.objects.get(id=pk)
        # Se crea el serializer
        serializer = ProductSerializer(message)
        # Se envía la respuesta a la solicitud
        return Response(serializer.data)
    ...
    def update(self, request, pk=None): 
        ...
        message = Product.objects.get(id=pk)
        # Se crea el serializer con los datos recibidos
        serializer = ProductSerializer(instance=message, data=request.data)
        # Se verifica si el serializer es válido
        serializer.is_valid(raise_exception=True)
        # Se guarda el serializer
        serializer.save()
